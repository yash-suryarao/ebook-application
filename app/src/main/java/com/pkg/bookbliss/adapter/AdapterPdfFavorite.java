...
import com.pkg.bookbliss.activities.PdfDetailActivity;
import com.pkg.bookbliss.databinding.RowPdfFavoriteBinding;
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        MyApplication.loadPdfFromUrlSinglePage(""+bookUrl, ""+bookTitle, holder.pdfView, holder.progressBar);
