...
import com.pkg.bookbliss.databinding.ActivityProfileEditBinding;
...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    private void loadUserInfo() {
        Log.d(TAG, "loadUserInfo: loadUserInfo: Loading user info of user " + firebaseAuth.getUid());
    ...
    private void pickImageCamera() {
        //init to pick image from camera
        ContentValues values = new ContentValues();
        values.put(MediaStore.Images.Media.TITLE, "New Pick"); //Image title
        values.put(MediaStore.Images.Media.DESCRIPTION, "Simple Image Description");
    ...
    private void pickImageGallery() {
        //init to pick image from gallery
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Intent data = result.getData(); //no need here as in camera case we have image in imageUri variable
