...
import com.pkg.bookbliss.Constants;
import com.pkg.bookbliss.databinding.ActivityPdfViewBinding;
...
public class PdfViewActivity extends AppCompatActivity {
    ...
    private void loadBookDetails() {
        ...
        //Database Reference to get book details e.g. get url using book id
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Log.d(TAG, "loadDataChange: PDF URL..."+pdfUrl);
        ...
        reference.getBytes(Constants.MAX_BYTES_PDF)
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        ...
                        //load book using bytes
                        binding.pdfView.fromBytes(bytes)
                                .swipeHorizontal(true) //use false to scroll vertical, set true to swipe horizontal
                                .onPageChange(new OnPageChangeListener() {
                                    @Override
                                    public void onPageChanged(int page, int pageCount) {
                                        //set current and total pages in toolbar subtitle
                                        int currentPage = (page + 1);
                                        binding.toolbarSublitleTv.setText(currentPage+"/"+pageCount);
