...
import com.pkg.bookbliss.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //handle click, go  previous activity
    ...
    /*---- Book Uploading to Firebase Database ----*/
    ...
    private void uploadPdfInfoToDb(String uploadedPdfUrl, long timestamp) {
        ...
        Log.d(TAG, "uploadPdfToStorage: uploading pdf info to db...");
    ...
    private void loadPdfCategories() {
        ...
        //db references to load categories... db > categories
...
* Currently: We are adding pdf category while adding pdf to relation db
